...
| `fileControlNoDownload` | checkbox | Tắt nút download |
| `fileControlNoFullscreen` | checkbox | Tắt nút fullscreen |
...
| `overlayAriaLabel` | aria-label cho icon |
| `overlayIconTypography` | Typography icon |
