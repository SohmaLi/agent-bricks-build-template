...
| `linksSeparator` | separator | Separator group links style |
...
```json
{
  ...
  "settings": {
    ...
    "newTab": true,
    "linkRel": "nofollow",
    "_cssCustom": "#brxe-psShare a { width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; }"
  }
}
```
