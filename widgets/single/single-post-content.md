...
| `info` | info | Thông báo về data source mode |
...
```json
{
  ...
  "settings": {
    "dataSource": "editor",
    "_cssCustom": "#brxe-pcContent { font-size: 17px; line-height: 1.8; color: #444; } #brxe-pcContent h2 { font-size: 24px; margin-top: 40px; } #brxe-pcContent img { max-width: 100%; }"
  }
}
```
