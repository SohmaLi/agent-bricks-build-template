...
| `alignmentSeparator` | separator | Separator group alignment controls |
...
```json
{
  ...
  "settings": {
    ...
    "direction": "row",
    "gap": "16px",
    "_cssCustom": "#brxe-siBar li { transition: transform 0.2s; } #brxe-siBar li:hover { transform: translateY(-2px); }"
  }
}
```
