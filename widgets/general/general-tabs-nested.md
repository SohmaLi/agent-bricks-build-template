...
| `titleMargin` | Margin tab button |
| `titlePadding` | Padding tab button (default: 20px) |
...
| `titleActiveSeparator` | Separator group title active styles |
| `titleActiveTypography` | Typography active |

### Content Group (selector: `> .tab-content`)
| Key | Mô tả |
|-----|-------|
| `contentMargin` | Margin content area |
| `contentPadding` | Padding content area (default: 20px) |
